        ...
        <div style={{ padding: '16px 20px', fontSize: 13, color: '#aaa', lineHeight: 1.7 }}>
          ...
          <Section n="2" title="El Sistema de Puntos (La Calculadora Janz)">
            ...
            <ul style={{ marginTop: 8, paddingLeft: 16, display: 'flex', flexDirection: 'column', gap: 4 }}>
              <li><b style={{ color: '#E8B84B' }}>Acierto Ganador/Empate:</b> {config?.pointsWinner ?? 1} punto{(config?.pointsWinner ?? 1) !== 1 ? 's' : ''}.</li>
              <li><b style={{ color: '#E8B84B' }}>Resultado Exacto (Pleno):</b> +{config?.pointsExact ?? 5} puntos extra.</li>
              <li><b style={{ color: '#E8B84B' }}>Puntos por Compra (El MVP):</b> Cada combo comprado suma {config?.pointsPerOrder ?? 1} punto{(config?.pointsPerOrder ?? 1) !== 1 ? 's' : ''} directo a tu tabla.</li>
            </ul>
          ...
          <Section n="3" title="Mecánica del Juego">
            Los pronósticos de cada fecha se cierran {config?.cutoffMinutes ?? 30} minutos antes de cada partido.
            <div style={{ marginTop: 6 }}><b style={{ color: '#fff' }}>Condición de Oro:</b> Para ser elegible para cualquiera de los 3 premios finales, el participante deberá haber realizado al menos 3 compras durante la duración del torneo.</div>
          </Section>
      ...
      <div style={{ width: '100%', maxWidth: 360 }}>
        ...
        <div style={{ background: '#111', border: '1px solid #1e1e1e', borderRadius: 16, padding: 24 }}>
          ...
          <p style={{ color: '#2a2a2a', fontSize: 11, textAlign: 'center', marginTop: 14, marginBottom: 0, lineHeight: 1.5 }}>
            Solo pueden participar clientes con al menos un pedido realizado.
          </p>
        </div>
